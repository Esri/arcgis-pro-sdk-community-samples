...
3. Select the 'Add-in' tab, and then click on 'Probuttons Dockpane' to open the test dockpane.  
![Screen1](Screenshots/Screen1.png)  
4. All button except the 'Open Project' button implement a 'Command Parameter' which passes the content of a text box to the code behind for the ICommand  
![Screen1](Screenshots/Screen2.png)  
5. Click the 'Open Project' image button to open a new ArcGIS project file.  
