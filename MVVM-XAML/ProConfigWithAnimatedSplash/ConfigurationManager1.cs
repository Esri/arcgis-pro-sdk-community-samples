...
using ProConfigWithAnimatedSplash.UI;
using System;
...
namespace ProConfigWithAnimatedSplash
{
  internal class ConfigurationManager1 : ConfigurationManager
  {
    ...
    {
      get { return "ProConfigWithAnimatedSplash"; }
    }
    ...
    protected override ImageSource Icon
    {
      get
      {
        return new BitmapImage(new Uri(@"pack://application:,,,/ProConfigWithAnimatedSplash;component/Images/favicon.ico"));
      }
    }
