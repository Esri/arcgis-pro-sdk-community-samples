#arcgis-pro-sdk-community-samples-content - ArcGIS Pro 1.1 (Beta)
...
The content topic includes functionality that alters, edits, and/or manipulates the project content of ArcGIS Pro. This includes sharing and search APIs, portal, database, and server connections. Content functionality is primarily found in the ArcGIS.Desktop.Core.dll and ArcGIS.Desktop.Catalog.dll.
