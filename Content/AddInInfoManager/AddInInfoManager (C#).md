...
4. Open the Add-in tab and click the "Show AddIn Info Manager" button to open "AddIn List" dockpane.  
![UI](Screenshots/screenshot1.png)  
5. Click on any of the Add-ins in "AddIn List" to delete the selected add-in.  
