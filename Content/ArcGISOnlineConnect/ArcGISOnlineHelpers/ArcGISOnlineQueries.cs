    ...
    public enum AGSQueryType {
        ...
        public static class AGSQueries
        {
                ...
                <AGSQueryType, string>()
            {
                ...
                {AGSQueryType.GetItem, "/sharing/content/items/{0}?f=pjson;Item;<Enter an ArcGIS Online Item Id>"},
                {AGSQueryType.GetItemPkInfo, "/sharing/content/items/{0}/item.pkinfo?f=pjson;Items;<Enter an ArcGIS Online Item Id>"},
                {AGSQueryType.GetItemData, "/sharing/content/items/{0}/data?f=pjson;Items;<Enter an ArcGIS Online Item Id>"},
                ...
                {AGSQueryType.GetGroupUsers, "/sharing/rest/community/users?q={0}&f=pjson;User Name;<Enter your ArcGIS Online Username>"},
                {AGSQueryType.GetUserTags, "/sharing/rest/community/users/{0}/tags?f=pjson;User Name;<Enter your ArcGIS Online Username>"}
            };
