...
namespace CustomCategoriesExtraReport
{
  /// <summary>
  ...
  ///   
  /// CustomCategoriesExtraReport add-in also creates a component for the AcmeCustom_Reports category
  /// and likewise registers it in the category within ~its~ config.daml. 
  /// CustomCategoriesExtraReport.ExtraReport class implements the IAcmeCustomReport contract (as
  ...
  internal class Module1 : Module
  {
    ...
    public static Module1 Current
    {
      get
      {
        return _this ?? (_this = (Module1)FrameworkApplication.FindModule("CustomCategoriesExtraReport_Module"));
      }
    }
