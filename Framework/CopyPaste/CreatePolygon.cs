...
namespace CopyPaste
{
  internal class CreatePolygon : MapTool
  {
    ...
    protected override Task OnToolActivateAsync(bool active)
    {
      QueuedTask.Run(() =>
      {
        ...
        _polygonSymbol = SymbolFactory.Instance.ConstructPolygonSymbol(solidColorHatch, SymbolFactory.Instance.ConstructStroke(ColorFactory.Instance.BlueRGB, 1.5));
      });
    ...
    {
      var graphicsLayerName = @"My polygons";
