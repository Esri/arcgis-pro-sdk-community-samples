...
using GetRecentPortalProjects.UI;
...
namespace GetRecentPortalProjects
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        {
            get { return "GetRecentPortalProjects"; }
        }
        ...
        protected override ImageSource Icon
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/GetRecentPortalProjects;component/Images/favicon.ico"));
            }
        }
