...
namespace BatchTracingCoreCommon.Classes
{
    public class PartitionAnalysis
    {
        public static bool Execute(string analysisName, IDictionary<string, object> configuration)
        {
            ...
            return PartitionUsingPaths(inputWorkspace, sourceUtilityNetwork, networkSourceName, assetGroupCode, definitionQuery, sourceResultField,
                outputWorkspace, outputPolygons, outputPolylines, outputPoints, outputTable, functionFieldCount,
                outputAnalysisField, outputResultField, namedTraceConfiguration, analysisName);
        }
        
        private static bool PartitionUsingPaths(string inputWorkspacePath, string utilityNetworkClassName, string networkSourceName, int assetGroupCode, string definitionQuery, string sourceResultField,
