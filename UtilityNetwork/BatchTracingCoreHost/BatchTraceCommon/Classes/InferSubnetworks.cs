...
namespace BatchTracingCoreCommon.Classes
{
    public class InferSubnetworks
    {
        ...
        public static bool Execute(string analysisName, IDictionary<string, object> configuration)
        {
            ...
            return PartitionUsingSubnetworkControllers(inputWorkspace, sourceUtilityNetwork, domainNetworkName, tierName,
        ...
        private static bool PartitionUsingSubnetworkControllers(string inputWorkspacePath, string utilityNetworkClassName, string domainNetworkName, string tierName,
            ...
            string portalUrl, string portalUsername, string portalPassword, string outputFile, string analysisName, int functionFieldCount)
        {
            try
            {
                ...
                var utilityNetworkWorkspace = Helpers.OpenGeodatabase(inputWorkspacePath, portalUrl, portalUsername, portalPassword);
                var outputWorkspace = Helpers.OpenGeodatabase(outputWorkspacePath);
                var utilityNetwork = utilityNetworkWorkspace.OpenDataset<UtilityNetwork>(utilityNetworkClassName);
