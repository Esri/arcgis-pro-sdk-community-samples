#arcgis-pro-sdk-community-samples-taskassistant - ArcGIS Pro 1.1 (Beta)

----------
     This page was generated by a tool.
     Manual changes to this page are lost when the page is regenerated.

This repository contains ArcGIS Pro Add-In Samples for the ArcGIS Pro 1.1 SDK for .NET (Beta).  The samples are demonstrating the key functions that are falling under the 'Content' topic.  
The Task Assistant topic includes functionality that provides access to the Tasks framework allowing developers to access, open, close or export task items. Task Assistant functionality is primarily found in the ArcGIS.Desktop.TaskAssistant.dll.

## Features

This folder contains ArcGIS Pro Add-In Samples that fall under the 'Task Assistant' topic:
