...
7. Click on the 'Add-ins' tab.    
8. Click on the 'MapTool With Embeddable' button to enable the map tool.  Click on the search button in the embeddable control.  
![UI](Screenshots/Screen1.png)  
9. The found location is marked on the map.  
