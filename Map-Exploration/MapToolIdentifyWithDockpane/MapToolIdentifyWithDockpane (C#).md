...
8. Click the 'Identify Features' button and draw a rectangle over the features to show in the dockpane.  
![UI](Screenshots/2MapTool2D.png)  
9. Validate the result.  
![UI](Screenshots/2MapTool2D-2.png)  
10. Switch to the Portland 3D City map view and perform the identify feature function on the 3D scene.  
