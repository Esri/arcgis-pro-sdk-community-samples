...
namespace LayoutWithLabels
{
	...
	internal class SetPage
	{
		...
		internal static SetPage FromJson(string json)
		{
			...
			return (SetPage)serializer.DeserializeObject(json);
		}
		/// <summary>
	...
	internal class SetPages
	{
		...
		internal SetPages()
		{
			...
			{
				new SetPage() { Name = "Sample - A4 - Portrait", MapFrameName = "Sample Map Frame", LayoutName = "Sample Map", Width = 29.7, Height = 21.0, LinearUnit = LinearUnit.Centimeters },
				new SetPage() { Name = "Sample - A3 - Portrait", MapFrameName = "Sample Map Frame", LayoutName = "Sample Map", Width = 42, Height = 29.7, LinearUnit = LinearUnit.Centimeters },
				new SetPage() { Name = "Sample - A2 - Portrait", MapFrameName = "Sample Map Frame", LayoutName = "Sample Map", Width = 59.4, Height = 42, LinearUnit = LinearUnit.Centimeters }
			};
