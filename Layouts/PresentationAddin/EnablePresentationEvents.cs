...
{
  internal class EnablePresentationEvents : Button
  {
      ...
      ArcGIS.Desktop.Presentations.Events.PresentationEvent.Subscribe((args) =>
      {
        ...
        switch (args.Hint)
        {
          case PresentationEventHint.PropertyChanged:
            MessageBox.Show("Presentation property changed");
            break;
          case PresentationEventHint.PageAdded:
            MessageBox.Show("new page added");
            break;
          case PresentationEventHint.PageRemoved:
            MessageBox.Show("page removed from the presentation");
            break;
          case PresentationEventHint.PageSettingChanged:
            MessageBox.Show("page settings changed");
            break;
        }
      });
    }
