...
{
  internal class AddBlankPage : Button
  {
    protected override void OnClick()
    {
      ...
      QueuedTask.Run(() => {
        ...
        var blankPage = presentation.AddBlankPage(BlankPageTemplateType.TitleAndParagraph, -1);
        if (blankPage == null)
        {
          MessageBox.Show("Failed to add blank page.");
          return;
        }
      });
    }
