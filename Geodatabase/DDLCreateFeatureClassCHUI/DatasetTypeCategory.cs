...
{
	/// <summary>
	/// Represents a category for a dataset type, including its name and associated dataset type.
	/// </summary>
	/// <remarks>
	/// This class is used to group datasets by type and provide a descriptive name for the
	/// category.</remarks>
