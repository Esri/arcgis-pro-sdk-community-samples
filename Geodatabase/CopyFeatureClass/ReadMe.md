...
4. Open any project with a map that contains as least one Point, Line or Polygon feature layer.  
5. Click on the 'Add-in' tab and note the 'Copy Feature Layer' group.  
![UI](Screenshots/Screen1.png)  
6. On the map's table of content click on any feature layer and then click the 'Copy Feature Layer' button.  
