...
{  /// <summary>
   ...
   /// 1. Note the status output logging the progress of the aprx batch processing.
  ...
  internal class Module1 : Module
  {
    ...
    /// </summary>
    public static Module1 Current => _this ??= (Module1)FrameworkApplication.FindModule("LayerGDBInfo_Module");
