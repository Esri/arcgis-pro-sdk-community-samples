...
{
    internal class DeleteFeatureClassWithSubtypes : Button
    {
        ...
        #region Deleting subtypes from FeatureClass

        public void DeleteSubtypeFromFeatureClass(SchemaBuilder schemaBuilder, FeatureClassDefinition featureClassDefinition)
        {
