...
{
  internal class CreateGDB : Button
  {
    protected override async void OnClick()
    {
      ...
      try
      {
        await QueuedTask.Run(() =>
              {
                DeleteFeatureClass(fileGdbPath, Module1.TestFcName);
                CreateFeatureClass(fileGdbPath, Module1.TestFcName);
              });
        Module1.MemoryGDBStatsViewModel.FileStatus = "Created";
        await QueuedTask.Run(() =>
              {
