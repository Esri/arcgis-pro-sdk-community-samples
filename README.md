...
* Microsoft .NET Runtime 10.0.3 or [better](https://github.com/dotnet/core/blob/main/release-notes/10.0/README.md). [Download .NET 10.0](https://dotnet.microsoft.com/en-us/download/dotnet/10.0)
* To upgrade an ArcGIS Pro SDK project build with release 3.0-3.2 to release 3.3-3.6 (.NET 8.0), and release 3.7 (.NET 10.0), see the [ProGuide .NET 10 Upgrade](https://github.com/esri/arcgis-pro-sdk/wiki/ProGuide-NET-10-Upgrade)  
...
We recommend installing a minimum version of 18.4.1 of Visual Studio. This version includes .NET 10 as part of the Visual Studio 2026 install (.NET SDK 10.0.x).  Consult Microsoft’s [Download .NET 10.0](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) site for more information.

#### Third party assemblies
_**Newtonsoft Json**_  
* At 3.7, ArcGIS Pro is using version 13.0.3.27908 of the Newtonsoft Json NuGet. If you require Newtonsoft NuGet in your add-ins it is recommended to use the same version.  
...
Below is the list of 325 ArcGIS Pro samples that are included in this repository.  

#### AI Assistant

* [AILayoutFunction (c#)](../../tree/master/AIAssistant/AILayoutFunction)  


#### Connectivity

* [Connectivity (c#)](../../tree/master/Connectivity/Connectivity)  
...
* [AnnotationRetrofit (c#)](../../tree/master/Editing/AnnotationRetrofit)  
...
* [ConstructionSplitTool (c#)](../../tree/master/Editing/ConstructionSplitTool)  
...
* [MyCopilotAddin (c#)](../../tree/master/Editing/MyCopilotAddin)  
...
* [PublishFeatureLyrPython (c#)](../../tree/master/Geoprocessing/PublishFeatureLyrPython)  
...
* [DDLCreateFeatureClassCHUI (c#)](../../tree/master/Geodatabase/DDLCreateFeatureClassCHUI)  
* [DDLCreateFromSchema (c#)](../../tree/master/Geodatabase/DDLCreateFromSchema)  
...
* [ImportCsv (c#)](../../tree/master/Geodatabase/ImportCsv)  
...
* [TabularDataOptions (c#)](../../tree/master/Map-Exploration/TabularDataOptions)  
* [TimeNavigation (c#)](../../tree/master/Map-Exploration/TimeNavigation)  
* [ToolGetFeatures (c#)](../../tree/master/Map-Exploration/ToolGetFeatures)  
...
* [TimeLayerAttributes (c#)](../../tree/master/StreamLayers/TimeLayerAttributes)  
...
* [Show Flow Arrows (c#)](../../tree/master/UtilityNetwork/Show Flow Arrows)  
...
* [WorkflowManagerSampleAddIn (c#)](../../tree/master/WorkflowManager/WorkflowManagerSampleAddIn)  
...
* [FeatureLyrToWebLayer (c#)](../../tree/master/Sharing/FeatureLyrToWebLayer)  
