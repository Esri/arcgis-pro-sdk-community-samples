...
namespace ProSqlExpressDb
{
    ...
    /// <summary>
    /// tracks metadata needed to handle a Pro SQL table / feature class
    /// </summary>
    public class ProSqlExpressTableInfo
    {
        /// <summary>
		...
		/// <summary>
		/// Table Path (includes feature dataset)
		/// </summary>
        ...
        /// </summary>
        public ProSqlExpressFieldInfo FieldInfo { get; set; }
    }
