...
namespace ProDataReader
{
    internal class ProDataProjectItemContainer : CustomProjectItemContainer<ProDataProjectItem>
    {
        ...
        public static readonly string ContainerName = "ProDataReaderContainer";
        ...
        public override ImageSource LargeImage
        {
            get
            {
                var largeImg = new BitmapImage(new Uri(@"pack://application:,,,/ProDataReader;component/Images/FolderWithGISData32.png"));
                return largeImg;
            }
        }
        ...
        public override Task<System.Windows.Media.ImageSource> SmallImage
        {
            get
            {
                var smallImage = new BitmapImage(new Uri(@"pack://application:,,,/ProDataReader;component/Images/FolderWithGISData16.png"));
