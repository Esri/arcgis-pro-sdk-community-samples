...
namespace ProMdbPluginDatasource
{
    ...
    /// </summary>
    public class ProMdbPluginTableTemplate : PluginTableTemplate, IDisposable, IPluginRowProvider
    {
        ...
        private readonly ProMdbAccessDb.ProMdbAccessDb _accessDb;
        private readonly string _tableName;
        private readonly DataTable _dataTable = new DataTable();
        private Envelope _gisExtent;

        private readonly SpatialReference _spatialReference;
        private readonly ProMdbTableInfo _tableInfo;
        ...
        private PluginCursorTemplate SearchInternal(QueryFilter qf)
        {
            ...
            return new ProMdbPluginCursorTemplate(this,
                                            oids,
                                            columns,
        ...
        private List<int> ExecuteQuery(QueryFilter qf)
        {
            ...
            _dataTable.Clear();
            int recCount = _accessDb.QueryTable(_tableName, subFields, whereClause, qf.PostfixClause, _dataTable);
