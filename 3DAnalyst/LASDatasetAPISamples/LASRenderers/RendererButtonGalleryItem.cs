...
{
  /// <summary>
  /// Represents a gallery item for a renderer button
  /// </summary>
  internal class RendererButtonGalleryItem
  {
    internal RendererButtonGalleryItem(string id, string group, IPlugInWrapper plugin)
    {
      CommandID = id;
