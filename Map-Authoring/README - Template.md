#arcgis-pro-sdk-community-samples-map-authoring - ArcGIS Pro 1.1 (Beta)

----------
     This page was generated by a tool.
     Manual changes to this page are lost when the page is regenerated.

This repository contains ArcGIS Pro Add-In Samples for the ArcGIS Pro 1.1 SDK for .NET (Beta).  The samples are demonstrating the key functions that are falling under the 'Map Authoring' topic.  
The Map Authoring topic includes functionality that creates, manipulates, edits, or uses Maps and Layers. This includes properties, symbology, renderers, and table of contents, Map Authoring API functionality is primarily found in ArcGIS.Desktop.Mapping.dll.
