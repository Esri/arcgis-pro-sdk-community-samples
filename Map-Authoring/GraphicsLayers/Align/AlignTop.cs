...
{
  internal class AlignTop : MapTool
  {
    public AlignTop()
    {
      IsSketchTool = true;
    ...
    protected override async Task<bool> OnSketchCompleteAsync(Geometry geometry)
    {
      return await QueuedTask.Run(() => {
        ...
        {
          MessageBox.Show("Select more than 1 graphic element to align.", "Align Top");
          return true;
        }
        //Get the ID of Pro's Align Left button and use it. 
        var alignLeftCmd = FrameworkApplication.GetPlugInWrapper("esri_layouts_alignTop") as ICommand;
