...
7. The button on the left sets the current map's basemap layer   
to ArcGIS Online's Street basemap   
8. The other button allows you to add a new layer just by using a path or url   
and if it happens to be a feature layer, it shows total number of features in   
that layer  
