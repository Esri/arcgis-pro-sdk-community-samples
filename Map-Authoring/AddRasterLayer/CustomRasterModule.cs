...
{
    /// <summary>
    /// This sample provides a new tab and a button on the tab to create a new raster layer 
    ...
    {
        private static CustomRasterModule _this = null;

        /// <summary>
        /// Retrieve the singleton instance to this module here
        /// </summary>
        public static CustomRasterModule Current
        {
            get
            {
                return _this ?? (_this = (CustomRasterModule)FrameworkApplication.FindModule("ProAppRasterModule_Module"));
            }
        }
