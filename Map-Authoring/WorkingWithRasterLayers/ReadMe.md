...
This sample provides a new tab and buttons on the tab to   
  
1.) Create a new image service layer and add it to the current map.  
...
7. Click on the other buttons described above to set different properties in teh image service layer.  
