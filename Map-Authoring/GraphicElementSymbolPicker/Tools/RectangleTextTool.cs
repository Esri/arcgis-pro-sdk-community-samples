...
{
  internal class RectangleTextTool : LayoutTool
  {
    public RectangleTextTool()
    {
    ...
    protected override Task<bool> OnSketchCompleteAsync(Geometry geometry)
    {
      ...
      {
        var fontSize = Module1.SelectedSymbol.GetSize();
        var polygon = geometry as Polygon;    
        var ge = ElementFactory.Instance.CreateTextGraphicElement
                               (this.ActiveElementContainer, TextType.RectangleParagraph,
                                polygon.Extent,  
                                Module1.SelectedSymbol as CIMTextSymbol, "Text");
