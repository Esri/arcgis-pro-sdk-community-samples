...
{
  internal class FreehandLineTool : LayoutTool
  {
    public FreehandLineTool()
    {
    ...
    protected override Task<bool> OnSketchCompleteAsync(Geometry geometry)
    {
      ...
      if (geometry == null) return Task.FromResult(true);
      if (Module1.SelectedSymbol == null) return Task.FromResult(true);

      return QueuedTask.Run(() =>
      {
        //Geometry returned in a polygon.
        //Get the outline as a Polyline
