...
namespace EditorInspectorUI.InspectorUI
{
    ...
    public InspectorProviderTool()
    {
      ...
      //sets the DAML ID of the embeddable control to show in the dock pane when
      //     the tool is active.
    ...
    protected override async Task<bool> OnSketchCompleteAsync(Geometry geometry)
    {
      ...
      await QueuedTask.Run(() =>
      {
        ...
        //var selectionDictionary = new Dictionary<MapMember, List<string>>();
        var permitSelectionDictionary = new Dictionary<MapMember, List<PermitRecord>>();
        permitSelectionDictionary.Add(buildingPermitsLayer as MapMember, permitRecordList);
        #endregion
        // assign the dictionary to the view model - notifies the tree view to update
        _attributeControlVM.SelectedMapFeatures = permitSelectionDictionary;
