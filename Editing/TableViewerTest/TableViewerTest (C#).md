...
5. Open the project "ParcelIsland.aprx" in the "C:\Data\ParcelFabric\Island" folder.  
6. After the map view opens click on the 'TableView Tester' tab.   
![UI](Screenshots/Screen1.png)  
7. Click on the 'Tsunami/Hurricane' button to change the Attribute TableView's layout  
