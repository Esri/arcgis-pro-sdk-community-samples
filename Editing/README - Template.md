#arcgis-pro-sdk-community-samples-editing - ArcGIS Pro 1.1 (Beta)

----------
     This page was generated by a tool.
     Manual changes to this page are lost when the page is regenerated.

This repository contains ArcGIS Pro Add-In Samples for the ArcGIS Pro 1.1 SDK for .NET (Beta).  The samples are demonstrating the key functions that are falling under the 'Editing' topic.  
The 'Editing' topic functionality that edits features or uses edit settings such as snapping. Editing functionality is found in ArcGIS.Desktop.Editing.dll.
